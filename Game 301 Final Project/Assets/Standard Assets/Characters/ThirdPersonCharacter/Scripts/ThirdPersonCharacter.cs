...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		bool m_Crouching;
        float m_JumpSpeedMultiplyer = 1f;
        ...
        public void Move(Vector3 move, bool crouch, bool jump)
        {
            ...
            // The stuff above fucks up movement for actually moving but is needed for the animator to work properly!
		...
		void HandleAirborneMovement(Vector3 movement)
		{
            //float yValue = m_Rigidbody.velocity.y;
            ...
            //movement *= m_JumpSpeedMultiplyer;
            //movement.y = yValue;
		...
		void HandleGroundedMovement(bool crouch, bool jump, Vector3 movement)
		{
            ...
            {
                m_Rigidbody.velocity = (movement * m_MoveSpeedMultiplier);
            }
		}
